...
export function version (platformVersion: Version, baseImage: string, baseSha256: string) {
  ...
  return {
    platformName,
    platformVersion,
    Connection:   CW.Axelar.Connection as { new (...args: unknown[]): Connection },
    Identity:     CW.Axelar.MnemonicIdentity as { new (...args: unknown[]): Identity },

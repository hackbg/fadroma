...
export function makeIdentity (
  { name, address }: Pick<Identity, 'name'|'address'>
) {
  return {
    name,
    address,
...
export function makeAgent (
  { chain, identity, fees }: Pick<Agent, 'chain'|'identity'|'fees'>
): Agent {
  ...
  return {
    ...
    fetchBalance (...args) { throw Error.Unimplemented() },
    getConnection () { throw Error.Unimplemented() },
    batch () { throw Error.Unimplemented() },
    send (...args) { return send(this, ...args) },
    upload (...args) { return upload(this, ...args) },
    instantiate (...args) { return instantiate(this, ...args) },
    execute (...args) { return execute(this, ...args) }
  }
}

/** Extend the object returned by this function to implement transaction support. */
export function makeSigningConnection (
  { chain, identity }: Pick<SigningConnection, 'chain'|'identity'>
): SigningConnection {
  return {
    get chain () { return chain },
    ...
    get identity () { return identity },
    get address () { return identity.address },
    sendImpl (...args) { throw Error.Unimplemented() },
    uploadImpl (...args) { throw Error.Unimplemented() },
    instantiateImpl (...args) { throw Error.Unimplemented() },
    executeImpl (...args) { throw Error.Unimplemented() },
  }
}

/** Extend the object returned by this function to implement batched transaction support. */
export function makeBatch ({ agent }: Pick<Batch, 'agent'>): Batch {
  return {
...
export function makeChain ({ id }: Pick<Chain, 'id'>): Chain {
  return {
    get id () {
      return id
    },
...
export function makeConnection (): Connection {
  ...
  return {
    ...
    fetchBlockImpl () { throw Error.Unimplemented() },
    fetchHeightImpl () { throw Error.Unimplemented() },
    fetchBalanceImpl () { throw Error.Unimplemented() },
    fetchCodeInfoImpl () { throw Error.Unimplemented() },
    fetchCodeInstancesImpl () { throw Error.Unimplemented() },
    fetchContractInfoImpl () { throw Error.Unimplemented() },
    queryImpl () { throw Error.Unimplemented() },
  }
}

...
const SimfFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_simf_free(ptr >>> 0, 1));
...
export class Simf {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SimfFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_simf_free(ptr, 0);
    }
    /**
     * @param {string} source
     ...
     * @returns {object}
     */
    static build(source, options) {
        const ret = wasm.simf_build(source, options);
        if (ret[2]) {
...
if (Symbol.dispose) Simf.prototype[Symbol.dispose] = Simf.prototype.free;
...
export function build(source, options) {
    const ret = wasm.build(source, options);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_77bc3e92745e9a35 = function() { return logError(function (arg0, arg1) {

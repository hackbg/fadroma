...
export type Chain = ChainRef & Context & Api & ChainOptions &
...
export type Connection = ChainRef & Context & Api & ChainOptions & { url?: string|URL };
/** Block height. */
...
export type Tx = { id: Hash } & { chain: ChainRef, block: Height, data: unknown };

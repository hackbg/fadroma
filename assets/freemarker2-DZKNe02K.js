import { l as c, __tla as __tla_0 } from "./index-GVCbR69S.js";
...
\r	 }]),.:;=`,
      ...
      onEnterRules: [
        ...
        },
        {
          beforeText: new RegExp(`${t.open}#(?!(?:${s.join("|")}))([a-zA-Z_]+)([^/${t.close}]*(?!/)${t.close})[^${t.open}]*$`),
          action: {
            indentAction: c.IndentAction.Indent
          }
        }
      ]
    };
...
\r	 }]),.:;=`,
  ...
  function i(t, n) {
    const _ = `_${t.id}_${n.id}`, e = (u) => u.replace(/__id__/g, _), o = (u) => {
      const m = u.source.replace(/__id__/g, _);
          ...
          [
            ...
            t.id === "auto" ? {
              cases: {
                "$1==<": {
                  token: "@rematch",
                  switchTo: `@default_angle_${n.id}`
                },
                "$1==[": {
                  token: "@rematch",
                  switchTo: `@default_bracket_${n.id}`
                }
              }
            } : [
              {
...
export {
  C as TagAngleInterpolationBracket,
  B as TagAngleInterpolationDollar,
  w as TagAutoInterpolationBracket,
  T as TagAutoInterpolationDollar,
  v as TagBracketInterpolationBracket,
  D as TagBracketInterpolationDollar,
  __tla
};

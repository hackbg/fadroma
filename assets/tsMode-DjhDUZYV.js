import { c as M, e as w, U as F, a as P, M as v, l as f, t as K, R as O, __tla as __tla_0 } from "./index-GVCbR69S.js";
import "./index-DsRfobeB.js";
import "./cons-C8nhYyWL.js";
import { __tla as __tla_1 } from "./index-BTPAJTuf.js";
import "./index-CtQ99MjB.js";
let y, J, B, W, j, z, S, G, q, a, H, $, V, U, Q, I, C, E, A, ne, oe, ie, re;
let __tla = Promise.all([
  ...
  E = class {
    ...
    _getClient() {
      return this._client || (this._client = (async () => (this._worker = M({
        ...
        createWorker: () => new Worker(new URL("/assets/ts.worker-Cr7ZyNz2.js", import.meta.url), {
          type: "module"
        }),
        label: this._modeId,
        keepIdleModels: true,
      ...
      }), this._defaults.getEagerModelSync() ? await this._worker.withSyncedResources(w.getModels().filter((e) => e.getLanguageId() === this._modeId).map((e) => e.uri)) : await this._worker.getProxy()))()), this._client;
    }
  ...
  const s = {};
  s["lib.d.ts"] = true;
  s["lib.decorators.d.ts"] = true;
  s["lib.decorators.legacy.d.ts"] = true;
  s["lib.dom.asynciterable.d.ts"] = true;
  s["lib.dom.d.ts"] = true;
  s["lib.dom.iterable.d.ts"] = true;
  s["lib.es2015.collection.d.ts"] = true;
  s["lib.es2015.core.d.ts"] = true;
  s["lib.es2015.d.ts"] = true;
  s["lib.es2015.generator.d.ts"] = true;
  s["lib.es2015.iterable.d.ts"] = true;
  s["lib.es2015.promise.d.ts"] = true;
  s["lib.es2015.proxy.d.ts"] = true;
  s["lib.es2015.reflect.d.ts"] = true;
  s["lib.es2015.symbol.d.ts"] = true;
  s["lib.es2015.symbol.wellknown.d.ts"] = true;
  s["lib.es2016.array.include.d.ts"] = true;
  s["lib.es2016.d.ts"] = true;
  s["lib.es2016.full.d.ts"] = true;
  s["lib.es2016.intl.d.ts"] = true;
  s["lib.es2017.arraybuffer.d.ts"] = true;
  s["lib.es2017.d.ts"] = true;
  s["lib.es2017.date.d.ts"] = true;
  s["lib.es2017.full.d.ts"] = true;
  s["lib.es2017.intl.d.ts"] = true;
  s["lib.es2017.object.d.ts"] = true;
  s["lib.es2017.sharedmemory.d.ts"] = true;
  s["lib.es2017.string.d.ts"] = true;
  s["lib.es2017.typedarrays.d.ts"] = true;
  s["lib.es2018.asyncgenerator.d.ts"] = true;
  s["lib.es2018.asynciterable.d.ts"] = true;
  s["lib.es2018.d.ts"] = true;
  s["lib.es2018.full.d.ts"] = true;
  s["lib.es2018.intl.d.ts"] = true;
  s["lib.es2018.promise.d.ts"] = true;
  s["lib.es2018.regexp.d.ts"] = true;
  s["lib.es2019.array.d.ts"] = true;
  s["lib.es2019.d.ts"] = true;
  s["lib.es2019.full.d.ts"] = true;
  s["lib.es2019.intl.d.ts"] = true;
  s["lib.es2019.object.d.ts"] = true;
  s["lib.es2019.string.d.ts"] = true;
  s["lib.es2019.symbol.d.ts"] = true;
  s["lib.es2020.bigint.d.ts"] = true;
  s["lib.es2020.d.ts"] = true;
  s["lib.es2020.date.d.ts"] = true;
  s["lib.es2020.full.d.ts"] = true;
  s["lib.es2020.intl.d.ts"] = true;
  s["lib.es2020.number.d.ts"] = true;
  s["lib.es2020.promise.d.ts"] = true;
  s["lib.es2020.sharedmemory.d.ts"] = true;
  s["lib.es2020.string.d.ts"] = true;
  s["lib.es2020.symbol.wellknown.d.ts"] = true;
  s["lib.es2021.d.ts"] = true;
  s["lib.es2021.full.d.ts"] = true;
  s["lib.es2021.intl.d.ts"] = true;
  s["lib.es2021.promise.d.ts"] = true;
  s["lib.es2021.string.d.ts"] = true;
  s["lib.es2021.weakref.d.ts"] = true;
  s["lib.es2022.array.d.ts"] = true;
  s["lib.es2022.d.ts"] = true;
  s["lib.es2022.error.d.ts"] = true;
  s["lib.es2022.full.d.ts"] = true;
  s["lib.es2022.intl.d.ts"] = true;
  s["lib.es2022.object.d.ts"] = true;
  s["lib.es2022.regexp.d.ts"] = true;
  s["lib.es2022.string.d.ts"] = true;
  s["lib.es2023.array.d.ts"] = true;
  s["lib.es2023.collection.d.ts"] = true;
  s["lib.es2023.d.ts"] = true;
  s["lib.es2023.full.d.ts"] = true;
  s["lib.es2023.intl.d.ts"] = true;
  s["lib.es2024.arraybuffer.d.ts"] = true;
  s["lib.es2024.collection.d.ts"] = true;
  s["lib.es2024.d.ts"] = true;
  s["lib.es2024.full.d.ts"] = true;
  s["lib.es2024.object.d.ts"] = true;
  s["lib.es2024.promise.d.ts"] = true;
  s["lib.es2024.regexp.d.ts"] = true;
  s["lib.es2024.sharedmemory.d.ts"] = true;
  s["lib.es2024.string.d.ts"] = true;
  s["lib.es5.d.ts"] = true;
  s["lib.es6.d.ts"] = true;
  s["lib.esnext.array.d.ts"] = true;
  s["lib.esnext.collection.d.ts"] = true;
  s["lib.esnext.d.ts"] = true;
  s["lib.esnext.decorators.d.ts"] = true;
  s["lib.esnext.disposable.d.ts"] = true;
  s["lib.esnext.error.d.ts"] = true;
  s["lib.esnext.float16.d.ts"] = true;
  s["lib.esnext.full.d.ts"] = true;
  s["lib.esnext.intl.d.ts"] = true;
  s["lib.esnext.iterator.d.ts"] = true;
  s["lib.esnext.promise.d.ts"] = true;
  s["lib.esnext.sharedmemory.d.ts"] = true;
  s["lib.scripthost.d.ts"] = true;
  s["lib.webworker.asynciterable.d.ts"] = true;
  s["lib.webworker.d.ts"] = true;
  s["lib.webworker.importscripts.d.ts"] = true;
  s["lib.webworker.iterable.d.ts"] = true;
  A = function(c, e, t = 0) {
    ...
    if (o += c.messageText, t++, c.next) for (const i of c.next) o += A(i, e, t);
    return o;
  };
  function _(c) {
  ...
  H = class {
    ...
    isLibFile(e) {
      return e && e.path.indexOf("/lib.") === 0 ? !!s[e.path.slice(1)] : false;
    }
    getOrCreateModel(e) {
      const t = F.parse(e), o = w.getModel(t);
      if (o) return o;
      if (this.isLibFile(t) && this._hasFetchedLibFiles) return w.createModel(this._libFiles[t.path.slice(1)], "typescript", t);
      const i = K.getExtraLibs()[e];
      return i ? w.createModel(i.content, "typescript", t) : null;
    }
    _containsLibFile(e) {
      for (let t of e) if (this.isLibFile(t)) return true;
      return false;
    }
  ...
  W = class extends y {
    constructor(e, t, o, i) {
      ...
      this._disposables.push(w.onDidCreateModel((r) => l(r))), this._disposables.push(w.onWillDisposeModel(p)), this._disposables.push(w.onDidChangeModelLanguage((r) => {
        p(r.model), l(r.model);
      })), this._disposables.push({
        dispose() {
          for (const r of w.getModels()) p(r);
        }
      });
      const n = () => {
        for (const r of w.getModels()) p(r), l(r);
      };
    ...
    async _doValidate(e) {
      ...
      const r = n.reduce((d, g) => g.concat(d), []).filter((d) => (this._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []).indexOf(d.code) === -1), u = r.map((d) => d.relatedInformation || []).reduce((d, g) => g.concat(d), []).map((d) => d.file ? F.parse(d.file.fileName) : null);
      await this._libFiles.fetchLibFilesIfNecessary(u), !e.isDisposed() && w.setModelMarkers(e, this._selector, r.map((d) => this._convertDiagnostics(e, d)));
    }
    _convertDiagnostics(e, t) {
      const o = t.start || 0, i = t.length || 1, { lineNumber: l, column: p } = e.getPositionAt(o), { lineNumber: n, column: r } = e.getPositionAt(o + i), u = [];
...
`),
    ...
    _convertRelatedInformation(e, t) {
      ...
      return t.forEach((i) => {
        let l = e;
        if (i.file && (l = this._libFiles.getOrCreateModel(i.file.fileName)), !l) return;
        const p = i.start || 0, n = i.length || 1, { lineNumber: r, column: u } = l.getPositionAt(p), { lineNumber: d, column: g } = l.getPositionAt(p + n);
        o.push({
          resource: l.uri,
          startLineNumber: r,
          startColumn: u,
...
`)
  ...
  C = class extends y {
    ...
    async provideCompletionItems(e, t, o, i) {
      const l = e.getWordUntilPosition(t), p = new O(t.lineNumber, l.startColumn, t.lineNumber, l.endColumn), n = e.uri, r = e.getOffsetAt(t), u = await this._worker(n);
      if (e.isDisposed()) return;
    ...
    async resolveCompletionItem(e, t) {
      const o = e, i = o.uri, l = o.position, p = o.offset, r = await (await this._worker(i)).getCompletionEntryDetails(i.toString(), p, o.label);
      return r ? {
        uri: i,
        position: l,
        label: r.name,
    ...
    static createDocumentationString(e) {
      ...
      if (e.tags) for (const o of e.tags) t += `
...
` + u : "")
  ...
  j = class extends y {
    async provideDocumentHighlights(e, t, o) {
      ...
      if (!(!n || e.isDisposed())) return n.flatMap((r) => r.highlightSpans.map((u) => ({
  ...
  B = class extends y {
    ...
    async provideDefinition(e, t, o) {
      ...
      if (!n || e.isDisposed() || (await this._libFiles.fetchLibFilesIfNecessary(n.map((u) => F.parse(u.fileName))), e.isDisposed())) return;
      const r = [];
      for (let u of n) {
  ...
  U = class extends y {
    ...
    async provideReferences(e, t, o, i) {
      ...
      if (!r || e.isDisposed() || (await this._libFiles.fetchLibFilesIfNecessary(r.map((d) => F.parse(d.fileName))), e.isDisposed())) return;
      const u = [];
      for (let d of r) {
    ...
    async provideDocumentSymbols(e, t) {
      ...
      const p = (r, u) => {
        ...
        return {
          ...
          tags: [],
          children: (_a = r.childItems) == null ? void 0 : _a.map((g) => p(g, r.text)),
          containerName: u
        };
      };
...
`,
  ...
  z = class extends S {
    ...
    async provideDocumentRangeFormattingEdits(e, t, o, i) {
      ...
      if (e.isDisposed()) return;
      const u = await r.getFormattingEditsForRange(l.toString(), p, n, S._convertOptions(o));
      if (!(!u || e.isDisposed())) return u.map((d) => this._convertTextChanges(e, d));
    }
  };
  G = class extends S {
...
`
    ...
    async provideOnTypeFormattingEdits(e, t, o, i, l) {
      ...
      if (e.isDisposed()) return;
      const u = await r.getFormattingEditsAfterKeystroke(p.toString(), n, o, S._convertOptions(i));
      if (!(!u || e.isDisposed())) return u.map((d) => this._convertTextChanges(e, d));
    }
  };
  J = class extends S {
    async provideCodeActions(e, t, o, i) {
      ...
      if (e.isDisposed()) return;
      const g = await d.getCodeFixesAtPosition(l.toString(), p, n, u, r);
    ...
    _tsCodeFixActionToMonacoCodeAction(e, t, o) {
      const i = [];
      for (const p of o.changes) for (const n of p.textChanges) i.push({
        resource: e.uri,
        versionId: void 0,
        textEdit: {
  ...
  q = class extends y {
    async provideInlayHints(e, t, o) {
      ...
      return e.isDisposed() ? null : {
        hints: (await r.provideInlayHints(l, p, n)).map((g) => ({
          ...g,
          label: g.text,
  ...
  ne = function() {
    return new Promise((c, e) => {
      if (!T) return e("JavaScript not registered!");
      c(T);
    });
  };
  oe = function() {
    return new Promise((c, e) => {
      if (!L) return e("TypeScript not registered!");
      c(L);
    });
  };
  function R(c, e) {

import { R as Ge, l as x, e as w, U as Je, M as R, __tla as __tla_0 } from "./index-GVCbR69S.js";
let mt, bt, Rt, vt, xt, Mt, _t, kt, wt, It, pt, Et, Lt, At, k, Ye, C, v;
let __tla = Promise.all([
  ...
  (function(e) {
    function n(r, t) {
      return r === Number.MAX_VALUE && (r = j.MAX_VALUE), t === Number.MAX_VALUE && (t = j.MAX_VALUE), {
        line: r,
        character: t
      };
    }
  ...
  (function(e) {
    function n(r, t, a, u) {
      if (o.uinteger(r) && o.uinteger(t) && o.uinteger(a) && o.uinteger(u)) return {
        start: _.create(r, t),
        end: _.create(a, u)
      };
      if (_.is(r) && _.is(t)) return {
        start: r,
        end: t
      };
  ...
  (function(e) {
    function n(r, t, a) {
      ...
      return typeof t == "string" ? (s = false, u.kind = t) : E.is(t) ? u.command = t : u.edit = t, s && a !== void 0 && (u.kind = a), u;
    }
    e.create = n;
    function i(r) {
      let t = r;
  ...
  (function(e) {
    ...
    function r(a, u) {
      ...
      for (let d = f.length - 1; d >= 0; d--) {
        ...
        if (c <= l) s = s.substring(0, b) + g.newText + s.substring(c, s.length);
    ...
    function t(a, u) {
      ...
      t(f, u), t(l, u);
      let d = 0, g = 0, b = 0;
      for (; d < f.length && g < l.length; ) u(f[d], l[g]) <= 0 ? a[b++] = f[d++] : a[b++] = l[g++];
      for (; d < f.length; ) a[b++] = f[d++];
      for (; g < l.length; ) a[b++] = l[g++];
      return a;
    }
  })(qe || (qe = {}));
  class nt {
...
` && t++;
  ...
  pt = class {
    constructor(n, i, r) {
      ...
      this._disposables.push(w.onDidCreateModel(t)), this._disposables.push(w.onWillDisposeModel(a)), this._disposables.push(w.onDidChangeModelLanguage((u) => {
        a(u.model), t(u.model);
      })), this._disposables.push(r((u) => {
        ...
        dispose: () => {
          ...
          for (let u in this._listener) this._listener[u].dispose();
        }
  ...
  mt = class {
    ...
    provideCompletionItems(n, i, r, t) {
      ...
      return this._worker(a).then((u) => u.doComplete(a.toString(), k(i))).then((u) => {
        if (!u) return;
        const s = n.getWordUntilPosition(i), f = new Ge(i.lineNumber, s.startColumn, i.lineNumber, s.endColumn), l = u.items.map((d) => {
          const g = {
            label: d.label,
  ...
  v = function(e) {
    if (e) return new Ge(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
  };
  function at(e) {
...
` + e.value + "\n```\n"
  ...
  function ct(e) {
    if (e) return Array.isArray(e) ? e.map(Qe) : [
      Qe(e)
    ];
  }
  bt = class {
  ...
  function ft(e) {
    ...
    for (let i in e.changes) {
      const r = Je.parse(i);
      for (let t of e.changes[i]) n.push({
        resource: r,
        versionId: void 0,
        textEdit: {
          range: v(t.range),
  ...
  Et = class {
    ...
    provideDocumentFormattingEdits(n, i, r) {
      ...
      return this._worker(t).then((a) => a.format(t.toString(), null, et(i)).then((u) => {
        if (!(!u || u.length === 0)) return u.map(C);
      }));
    }
  };
  Lt = class {
    constructor(n) {
      this._worker = n, this.canFormatMultipleRanges = false;
    }
    provideDocumentRangeFormattingEdits(n, i, r, t) {
      const a = n.uri;
      return this._worker(a).then((u) => u.format(a.toString(), Ye(i), et(r)).then((s) => {
        if (!(!s || s.length === 0)) return s.map(C);
      }));
    }
  };
  function et(e) {
  ...
  It = class {
    ...
    provideColorPresentations(n, i, r) {
      const t = n.uri;
      return this._worker(t).then((a) => a.getColorPresentations(t.toString(), i.color, Ye(i.range))).then((a) => {
        if (a) return a.map((u) => {
          let s = {
            label: u.label
          };
  ...
  Mt = class {
    ...
    provideSelectionRanges(n, i, r) {
      const t = n.uri;
      return this._worker(t).then((a) => a.getSelectionRanges(t.toString(), i.map(k))).then((a) => {
        if (a) return a.map((u) => {
          const s = [];
          for (; u; ) s.push({
            range: v(u.range)

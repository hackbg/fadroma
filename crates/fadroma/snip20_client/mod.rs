...
use crate::{
    core::ContractLink,
    cosmwasm_std::{Addr, Binary, CosmosMsg, Querier, StdResult, Uint128},
    scrt::BLOCK_SIZE,
};
...
impl ISnip20 {
    ...
    pub fn mint(&self, recipient: &Addr, amount: Uint128) -> StdResult<CosmosMsg> {
        snip20::mint_msg(
            recipient.clone(),
            amount,
            self.memo.clone(),
    ...
    pub fn set_minters(&self, minters: &Vec<Addr>) -> StdResult<CosmosMsg> {
    ...
    pub fn transfer(&self, recipient: &Addr, amount: Uint128) -> StdResult<CosmosMsg> {
        snip20::transfer_msg(
            recipient.clone(),
            amount,
            self.memo.clone(),
    ...
    pub fn batch_transfer(&self, transfers: &[(Addr, Uint128)]) -> StdResult<CosmosMsg> {
    ...
    pub fn query_token_info(&self, querier: &impl Querier) -> StdResult<snip20::TokenInfo> {
